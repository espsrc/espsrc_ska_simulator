...
def main():
    parser = argparse.ArgumentParser(
        description="Monitor and plot memory usage from a CSV file."
    )
    parser.add_argument(
        "csv_file", type=str, help="Path to the CSV file containing memory usage data."
    )
    parser.add_argument("--sep", default=";", help="CSV separator (default: ';')")
    parser.add_argument(
        "--interval", type=float, default=30.0, help="Refresh interval in seconds."
    )
