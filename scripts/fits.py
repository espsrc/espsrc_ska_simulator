...
if __name__ == "__main__":
    try:
        ...
        argparser.add_argument("--I", type=float, default=None, help="Total Intensity in Jy")
        ...
        printlog (log_file, f"\t\tDiameter: {DIAMETERS[args.telescope.upper()].value} meters")
        ...
        try:
            ...
            survey_file = os.path.join(os.path.dirname(__file__), f'skymodel_incl0_stokes.fits')
            ...
            if os.path.exists(survey_file):
                ...
                if args.I is not None and args.I > 0:
                    fluxes = fluxes / np.max(fluxes) * args.I # Normalize to max intensity
            ...
            skyModel.explore_sky([source_ref.dec.value, source_ref.ra.value], filename=sources_path, cfun=np.abs)
